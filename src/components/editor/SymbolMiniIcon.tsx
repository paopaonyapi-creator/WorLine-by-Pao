...
export function SymbolMiniIcon({ symbolType }: { symbolType: string }) {
  ...
  switch (symbolType) {
    ...
    case "rebar":
      return <svg {...common}><line x1="4" y1="14" x2="24" y2="14" stroke={stroke} strokeWidth={sw} /><line x1="10" y1="12" x2="10" y2="16" stroke={stroke} strokeWidth={sw} /><line x1="18" y1="12" x2="18" y2="16" stroke={stroke} strokeWidth={sw} /></svg>;
    case "wire_junction":
    ...
    case "connector_base_soc":
      return <svg {...common}><rect x="10" y="10" width="8" height="8" stroke={stroke} strokeWidth={sw}/></svg>;
    ...
    case "ansi_cb_3p":
      return <svg {...common}><path d="M14 4 L14 10 Q18 10 18 14 Q18 18 14 18 L14 24" stroke={stroke} strokeWidth={sw} fill="none"/></svg>;
    case "ansi_fuse":
    ...
    case "ansi_disconnect":
      return <svg {...common}><line x1="14" y1="4" x2="14" y2="10" stroke={stroke} strokeWidth={sw} /><line x1="14" y1="10" x2="20" y2="16" stroke={stroke} strokeWidth={sw} /><line x1="14" y1="18" x2="14" y2="24" stroke={stroke} strokeWidth={sw} /><circle cx="14" cy="10" r="1" fill={stroke}/><circle cx="14" cy="18" r="1" fill={stroke}/></svg>;
    case "ansi_contactor":
      return <svg {...common}><circle cx="14" cy="14" r="7" stroke={stroke} strokeWidth={sw}/><text x="14" y="18" textAnchor="middle" fill={stroke} fontSize="8" fontWeight="bold">CON</text></svg>;
    ...
    case "ansi_pushbutton_no":
      return <svg {...common}><line x1="8" y1="12" x2="8" y2="16" stroke={stroke} strokeWidth={sw} /><line x1="20" y1="12" x2="20" y2="16" stroke={stroke} strokeWidth={sw} /><line x1="6" y1="10" x2="22" y2="10" stroke={stroke} strokeWidth={sw} /><line x1="14" y1="10" x2="14" y2="6" stroke={stroke} strokeWidth={sw} /></svg>;
    case "ansi_pushbutton_nc":
      return <svg {...common}><line x1="8" y1="12" x2="8" y2="16" stroke={stroke} strokeWidth={sw} /><line x1="20" y1="12" x2="20" y2="16" stroke={stroke} strokeWidth={sw} /><line x1="6" y1="12" x2="22" y2="12" stroke={stroke} strokeWidth={sw} /><line x1="14" y1="12" x2="14" y2="6" stroke={stroke} strokeWidth={sw} /></svg>;
    case "ansi_limit_switch_no":
