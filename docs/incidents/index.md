...
- 🟡 **Maintainer Locked Out** → [Admin access denied](admin-access-fails.md) *(Railway)* [🔎] [🛠️] [👤] [🤫]
...
- 🟠 **Revenue Leak (User Canceled)** → [Stripe canceled but Supabase active](stripe-canceled-supabase-active.md) *(Stripe + Supabase)* [🔎] [🛠️] [👤] [🤫]
