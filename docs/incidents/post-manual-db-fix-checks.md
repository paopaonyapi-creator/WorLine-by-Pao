...
*Running a manual SQL query or toggling booleans in Supabase Table Editor is risky. Complete this tiny checklist immediately after any manual database intervention to prevent leaving the system in a corrupted state.*
