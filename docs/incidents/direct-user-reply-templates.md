...
**When to use:** You gave them a temporary DB unblock while you look into the codebase. *(See [Temporary Unblock Safety](temp-unblock-safety.md) and [Post-Manual DB Fix Checks](post-manual-db-fix-checks.md))*
